...
<!-- Navigation -->
                ...
                <form id="sb-admin-form">
                    <div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" style="width:300px;" placeholder="Enter text" name="newsname" value="<?php echo ($editNew["newsname"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="catid" style="width:300px;" class="form-control">                            
                            <?php if(is_array($catinfos)): $i = 0; $__LIST__ = $catinfos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cat["catid"]); ?>" <?php if($editNew[catid] == $cat[catid]): ?>selected="selected"<?php endif; ?>><?php echo ($cat["catname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                    <div>
                        <div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" style="width:300px;" placeholder="Enter text" name="newsauthor" value="<?php echo ($editNew["newsauthor"]); ?>">
                        </div>
                    </div>
                    <div>
                        <label for="inputname" class="col-sm-1 control-label" style="font-size:20px;">描述:</label>
                        <div class="form-group">                   
                            <textarea style="width:300px;" class="form-control" rows="5" name="description"><?php echo ($editNew["description"]); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="inputname" class="col-sm-1 control-label" style="font-size:20px;">封面:</label>
                            ...
                            <img style="display: show" id="upload_org_code_img" src="<?php echo ($editNew["thumb"]); ?>" width="10%" height="10%">
                            <input id="file_upload_image" name="thumb" type="hidden" multiple="true" value="<?php echo ($editNew["thumb"]); ?>">
                    </div>
                    <div class="form-group">
                        <script id="editor" name="newscontent" type="text/plain" style="width:756px;height:500px;"><?php echo ($editNew["content"]); ?></script>
                    </div>
                    <input type="hidden" name="news_id" value="<?php echo ($editNew["news_id"]); ?>" />
    ...
    <script>
        var SCOPE={
            'edit_url' : './admin.php?c=news&a=add',
