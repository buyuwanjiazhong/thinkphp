                ...
                <form id="sb-admin-form">
                    <div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" style="width:300px;" placeholder="Enter text" name="menuname">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" style="width:300px;" placeholder="admin" name="menumodule">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" style="width:300px;" placeholder="Enter text" name="menucontroller">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" style="width:300px;" placeholder="Enter text" name="menuaction">
                        </div>
                    </div>
