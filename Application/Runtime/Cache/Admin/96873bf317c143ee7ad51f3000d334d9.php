...
<!-- Navigation -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover sb-table" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$top): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                            <td><?php echo ($top["position"]); ?></td>
                                            <td><?php echo ($top["newsname"]); ?></td>
                                            <td><?php echo (getCategory($top["catid"])); ?></td>
                                            <td class="center">
                                                <a href="javascript:void(0)" id="sb-edit" attr-id="<?php echo ($top["id"]); ?>" cat-id="<?php echo ($top["catid"]); ?>"><i class="fa fa-edit fa-fw"></i></a>
    ...
    <script>
        var SCOPE={
            'edit_url' : './admin.php?c=topArticle&a=edit',
        }
    </script>    
