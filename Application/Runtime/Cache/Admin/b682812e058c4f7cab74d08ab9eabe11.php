                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover sb-table" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                            <td><?php echo ($user["adminname"]); ?></td>
                                            <td><?php echo ($user["adminlevel"]); ?></td>
                                            <td><?php echo (getAuthorityInfo($user["adminlevel"])); ?></td>
                                            <td class="center"><?php echo (date("Y-m-d H:i",$user["lastlogintime"])); ?></td>
                                            <td class="center">
                                                <a href="javascript:void(0)" id="sb-edit" attr-id="<?php echo ($user["id"]); ?>"><i class="fa fa-edit fa-fw"></i></a>
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <a href="javascript:void(0)" id="sb-delete" attr-id="<?php echo ($user["id"]); ?>" attr-message="删除管理员"><p class="fa fa-times"></p></a>
                                            </td>
