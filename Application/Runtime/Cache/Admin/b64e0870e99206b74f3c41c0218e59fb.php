...
<!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">修改管理员权限</h1>
                    </div>
                <form id="sb-admin-form">
                    <div>
                        <label for="inputname" class="col-sm-1 control-label" style="font-size:20px;">名字:</label>
                        <div class="form-group">
                            <input type="text" class="form-control" style="width:300px;" placeholder="Enter text" name="adminname" value="<?php echo ($editAdmin["adminname"]); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="adminlevel" style="width:300px;" class="form-control">                            
                            <option value="2" <?php if($editAdmin["adminlevel"] == 2): ?>selected="selected"<?php endif; ?>>普通管理员</option>
                            <option value="1" <?php if($editAdmin["adminlevel"] == 1): ?>selected="selected"<?php endif; ?>>超级管理员</option>
                        </select>
                    </div>
    ...
    <script>
        var SCOPE={
            ...
            'edit_url' : './admin.php?c=admin&a=add',
