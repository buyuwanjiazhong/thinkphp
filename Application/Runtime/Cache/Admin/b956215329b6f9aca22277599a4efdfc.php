                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover sb-table" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                            <td><?php echo ($menu["name"]); ?></td>
                                            <td><?php echo (getMenuLevel($menu["level"])); ?></td>
                                            <td><?php echo ($menu["m"]); ?></td>
                                            <td><?php echo ($menu["c"]); ?></td>
                                            <td><?php echo ($menu["a"]); ?></td>
                                            <td class="center">
                                                <a href="javascript:void(0)" id="sb-edit" attr-id="<?php echo ($menu["id"]); ?>" attr-message="修改菜单"><i class="fa fa-edit fa-fw"></i></a>
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <a href="javascript:void(0)" id="sb-delete" attr-id="<?php echo ($menu["id"]); ?>" attr-message="删除菜单"><p class="fa fa-times"></p></a>
                                            </td>
