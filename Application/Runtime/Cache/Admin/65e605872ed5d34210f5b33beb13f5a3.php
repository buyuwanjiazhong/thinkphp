                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover sb-table" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo (date("Y-m-d H:i",$user["register_time"])); ?></td>
                                            <td class="center"><?php echo (date("Y-m-d H:i",$new["last_login_time"])); ?></td>

                                            <td class="center">
                                                <a href="javascript:void(0)" id="sb-edit"><i class="fa fa-edit fa-fw"></i></a>
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <a href="javascript:void(0)" id="sb-delete" attr-id="<?php echo ($user["id"]); ?>" attr-message="删除"><p class="fa fa-times"></p></a>
                                            </td>
