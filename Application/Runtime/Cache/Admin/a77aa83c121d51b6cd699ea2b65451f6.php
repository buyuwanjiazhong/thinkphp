        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <form id="sb-admin-form">
                    <div>
                        <label for="inputname" class="col-sm-1 control-label" style="font-size:20px;">菜单:</label>
                        <div class="form-group">
                            <input type="text" class="form-control" style="width:300px;" placeholder="Enter text" name="menuname" value="<?php echo ($editMenu["name"]); ?>">
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label for="inputname" class="col-sm-1 control-label" style="font-size:20px;">等级:</label>
                        <select name="menulevel" style="width:300px;" class="form-control">                            
                            <option value="2" <?php if($editMenu["level"] == 2): ?>selected="selected"<?php endif; ?>>普通管理员</option>
                            <option value="1"<?php if($editMenu["level"] == 1): ?>selected="selected"<?php endif; ?>>超级管理员</option>
                        </select>
                    </div>

                    <div>
                        <label for="inputname" class="col-sm-1 control-label" style="font-size:20px;">模块:</label>
                        <div class="form-group">
                            <input type="text" class="form-control" style="width:300px;" placeholder="admin" name="menumodule" value="<?php echo ($editMenu["m"]); ?>">
                        </div>
                    </div>

                    <div>
                        <label for="inputname" class="col-sm-1 control-label" style="font-size:20px;">控制:</label>
                        <div class="form-group">
                            <input type="text" class="form-control" style="width:300px;" placeholder="Enter text" name="menucontroller" value="<?php echo ($editMenu["c"]); ?>">
                        </div>
                    </div>

                    <div>
                        <label for="inputname" class="col-sm-1 control-label" style="font-size:20px;">方法:</label>
                        <div class="form-group">
                            <input type="text" class="form-control" style="width:300px;" placeholder="Enter text" name="menuaction" value="<?php echo ($editMenu["a"]); ?>">
                        </div>
                    </div>
                    <input type="hidden" name="menuid" value="<?php echo ($editMenu["id"]); ?>"/>
