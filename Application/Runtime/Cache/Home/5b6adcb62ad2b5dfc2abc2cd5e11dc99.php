...
<title>前端登录注册模板</title> 
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<link href="./Application/Home/View/Login/css/login2.css" rel="stylesheet" type="text/css" />

</head>
<body>
<body>
<h1>前端登录注册模板<sup>2015</sup></h1>
...
<div class="login" style="margin-top:50px;">
  ...
  <!--注册-->
    ...
    <div class="web_login">
        <form name="form2" id="regUser" accept-charset="utf-8"  action="./index.php?c=login&a=register" method="post">
...
<div class="jianyi">*推荐使用ie8或以上版本ie浏览器或Chrome内核浏览器访问本站</div>
    ...
    <script src="./Application/Home/View/Login/images/login.js"></script>
